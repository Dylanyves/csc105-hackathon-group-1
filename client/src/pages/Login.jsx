...
function Login(props) {
  ...
  return (
    <div class="bg-[url('/Users/kaungmyatkyaw/HackAThon/client/src/assets/images/mountain.jpg')] bg-cover">
      <div className="h-screen flex items-center justify-center">
        <div className="p-8 bg-gray-100 w-[400px] bg-[#22223B] rounded-2xl">
          <h1 className="text-center text-xl mb-10 text-gray-50">Welcome</h1>
